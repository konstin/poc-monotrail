...
$ VIRTUAL_ENV=.venv-benchmark hyperfine -p ".venv-benchmark/bin/pip uninstall -y plotly" \
  "target/release/install-wheel-rs install wheels/plotly-5.5.0-py2.py3-none-any.whl" \
  ".venv-benchmark/bin/pip install --no-deps wheels/plotly-5.5.0-py2.py3-none-any.whl"
          
Benchmark #1: target/release/install-wheel-rs install wheels/plotly-5.5.0-py2.py3-none-any.whl
...
Summary
  'target/release/install-wheel-rs install wheels/plotly-5.5.0-py2.py3-none-any.whl' ran
