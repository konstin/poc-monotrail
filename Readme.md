...
Benchmark #1: target/release/install-wheel-rs install-file wheels/plotly-5.5.0-py2.py3-none-any.whl
...
Summary
  'target/release/install-wheel-rs install-file wheels/plotly-5.5.0-py2.py3-none-any.whl' ran
